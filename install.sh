...
# https://raw.githubusercontent.com/MyMasWayVPN/acces/main/punten 
...
clear
wget -q -O /tmp/nameserver "https://raw.githubusercontent.com/MasWaySTORE/abc/ipuk/slowdns/nameserver" >/dev/null 2>&1
    chmod +x /tmp/nameserver
    bash /tmp/nameserver | tee /root/install.log
#wget https://raw.githubusercontent.com/mymaswayvpn/multi/main/slowdns/install-sldns.sh && chmod +x install-sldns.sh && ./install-sldns.sh
clear
