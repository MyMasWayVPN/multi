...
Isadmin=$(curl -sS https://raw.githubusercontent.com/MyMasWayVPN/acces/main/puntenmini | grep $MYIP | awk '{print $5}')
...
wget -qO- https://raw.githubusercontent.com/mymaswayvpn/multi/main/bot/BotAPI.sh >/etc/.maAsiss/.Shellbtsss
}
