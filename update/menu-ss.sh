...
shadowsockslink="ss://${shadowsocks_base64e}@$domain:$tls?plugin=xray-plugin;mux=0;path=/ss_ws;host=$domain;tls#${user}"
shadowsockslink1="ss://${shadowsocks_base64e}@$domain:$tls?plugin=xray-plugin;mux=0;serviceName=ssgrpc;host=$domain;tls#${user}"
...
clear
cat > /home/vps/public_html/ss_ws/ss-$user.txt <<-END
# sodosok ws
{ 
 "dns": {
    "servers": [
