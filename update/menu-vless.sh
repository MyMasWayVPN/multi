...
<b>🌟Server  :</b> <code>DD$domain</code>
<b>────────────────────</code>
...
echo -e "$COLOR1 ${NC} port NTLS     : $none" 
...
echo -e "$COLOR1 ${NC} Path          : $user/vless-grpc" 
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 ${NC} Link TLS :"
echo -e "$COLOR1 ${NC} ${vlesslink1}" 
echo -e "$COLOR1 ${NC}"   
echo -e "$COLOR1 ${NC} Link NTLS : "
