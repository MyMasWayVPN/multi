...
vmesslink4="vmess://$(echo $aww | base64 -w 0)"
systemctl restart xray > /dev/null 2>&1
...
echo -e "$COLOR1 ${NC} Path          : /vmessws" 
echo -e "$COLOR1 ${NC} Path 0P0K    : /worryfree - /kuota-habis" 
echo -e "$COLOR1 ${NC} Path WSS      : wss://bug.com/vmessws" 
